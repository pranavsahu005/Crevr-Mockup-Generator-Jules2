...
def blend_with_alpha_mask(
    ...
    linear_blend: Perform alpha blending in linear light space (Gamma 2.2 approximation).
    ...
    if linear_blend:
        # Convert to [0, 1] and then to linear light space (Gamma 2.2)
        ...
        # Convert back to sRGB space (Gamma 2.2) and scale back to 0-255
        composited = (composited_linear ** (1.0 / 2.2)) * 255.0
    else:
