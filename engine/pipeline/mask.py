...
def blend_with_alpha_mask(
    ...
    linear_blend: If True, blends in linear light space (Gamma 2.2 approximation).
    ...
    if linear_blend:
        # Convert to linear light space (Gamma 2.2 approximation)
        # Inputs are expected to be in 0-255, we normalize, apply exponent, and blend.
